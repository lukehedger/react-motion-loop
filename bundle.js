...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMotion = __webpack_require__(165);
	
	var _Pulse = __webpack_require__(180);
	
	var _Loop = __webpack_require__(187);
	...
	var App = exports.App = function App() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_Pulse.Pulse, null)
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: _App2.default.container },
	      ...
	      _react2.default.createElement(_Loop.Loop, null)
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Motion = __webpack_require__(166);
	
	exports.Motion = _interopRequire(_Motion);
	
	var _StaggeredMotion = __webpack_require__(174);
	
	exports.StaggeredMotion = _interopRequire(_StaggeredMotion);
	
	var _TransitionMotion = __webpack_require__(175);
	
	exports.TransitionMotion = _interopRequire(_TransitionMotion);
	
	var _spring = __webpack_require__(177);
	
	exports.spring = _interopRequire(_spring);
	
	var _presets = __webpack_require__(178);
	
	exports.presets = _interopRequire(_presets);
	
	// deprecated, dummy warning function
	
	var _reorderKeys = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapToZero = __webpack_require__(167);
	
	var _mapToZero2 = _interopRequireDefault(_mapToZero);
	
	var _stripStyle = __webpack_require__(168);
	
	var _stripStyle2 = _interopRequireDefault(_stripStyle);
	
	var _stepper3 = __webpack_require__(169);
	
	var _stepper4 = _interopRequireDefault(_stepper3);
	
	var _performanceNow = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var now = __webpack_require__(170)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styleTo = {
	  width: (0, _reactMotion.spring)(100, _reactMotion.presets.stiff),
	  height: (0, _reactMotion.spring)(100, _reactMotion.presets.stiff),
	  borderRadius: (0, _reactMotion.spring)(50, _reactMotion.presets.stiff)
	};
	
	var Pulse = exports.Pulse = function Pulse() {
	  return _react2.default.createElement(
	    _.ReactMotionLoop,
	    {
	      styleFrom: styleFrom,
	      styleTo: styleTo },
	    function (style) {
	      return _react2.default.createElement('div', { className: _App2.default.element, style: style });
	    }
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, 'ReactMotionLoop', {
	  enumerable: true,
	  get: function get() {
	    return _Component.ReactMotionLoop;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ReactMotionLoop = undefined;
	...
	var ReactMotionLoop = exports.ReactMotionLoop = _react2.default.createClass({
	  displayName: 'ReactMotionLoop',
	
	  propTypes: {
	    styleFrom: _react2.default.PropTypes.object.isRequired,
	    styleTo: _react2.default.PropTypes.object.isRequired
	  },
	  ...
	  onRest: function onRest() {
	    ...
	    this.raf = requestAnimationFrame(function () {
	      return _this.setState({ flag: !_this.state.flag });
	    });
	  },
	  render: function render() {
	    var _props = this.props;
	    var styleFrom = _props.styleFrom;
	    var styleTo = _props.styleTo;
	
	    var props = _objectWithoutProperties(_props, ['styleFrom', 'styleTo']);
	
	    var flag = this.state.flag;
	
	    var defaultStyle = Object.keys(styleFrom).reduce(function (result, key) {
	      return _extends({}, result, _defineProperty({}, key, _typeof(styleFrom[key]) === 'object' ? styleFrom[key].val : styleFrom[key]));
	    }, {});
	    var style = flag ? styleTo : styleFrom;
	
	    return _react2.default.createElement(_reactMotion.Motion, _extends({
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".src-example-App-App---app {\n  padding: 2em;\n}\n\n.src-example-App-App---element {\n  background-color: #ccc;\n}\n\n.src-example-App-App---container {\n  width: 200px;\n  height: 200px;\n}\n", "", {"version":3,"sources":["/./src/example/App/App.css"],"names":[],"mappings":"AAAA;EACE,aAAa;CACd;;AAED;EACE,uBAAuB;CACxB;;AAED;EACE,aAAa;EACb,cAAc;CACf","file":"App.css","sourcesContent":[".app {\n  padding: 2em;\n}\n\n.element {\n  background-color: #ccc;\n}\n\n.container {\n  width: 200px;\n  height: 200px;\n}\n"],"sourceRoot":"webpack://"}]);
	
	// exports
	exports.locals = {
		"app": "src-example-App-App---app",
		"element": "src-example-App-App---element",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styleFrom = {
	  ...
	  borderRadius: (0, _reactMotion.spring)(0)
	};
	var styleTo = {
	  width: (0, _reactMotion.spring)(100),
	  height: (0, _reactMotion.spring)(100),
	  borderRadius: (0, _reactMotion.spring)(50)
	};
	
	var Loop = exports.Loop = function Loop() {
	  return _react2.default.createElement(
	    _.ReactMotionLoop,
	    {
	      styleFrom: styleFrom,
